...
public class MarkView extends View {
    ...
    public MarkView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        DEFAULT_TEXT_SIZE = MyAppUtils.spToPx(getResources(), 16);
        MIN_SIZE = (int) MyAppUtils.dpToPx(getResources(), 48);
        DEFAULT_STROKE_WIDTH = MyAppUtils.dpToPx(getResources(), 2);
        DEFAULT_BG_RING_WIDTH = MyAppUtils.dpToPx(getResources(), 2);
